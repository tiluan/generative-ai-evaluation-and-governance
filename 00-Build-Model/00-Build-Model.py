...
# MAGIC %md
# MAGIC # Construa o Modelo (RAG Chain)
# MAGIC
# MAGIC Este notebook deve ser executado antes do módulo para criar e registrar um modelo que será utilizado para o restante do módulo.
# MAGIC
# MAGIC ** Observação**: Este notebook é executado por `Configuração de espaço de trabalho`. Não é necessário executar manualmente este notebook.
...
# MAGIC %md
# MAGIC ## Criar catálogo compartilhado
...
# MAGIC %md
# MAGIC ## Preparar dados
# MAGIC
# MAGIC 1. Ler `pdf` bruto em `pdf_raw_text` tabela delta
# MAGIC 2. Chunk usando llama-index & pandas_udf
# MAGIC 3. Materializar documentos fragmentados na `pdf_text_chunks` tabela delta
...
# MAGIC %md
# MAGIC ## Criar Databricks Vector Search Endpoint
# MAGIC
# MAGIC 1. Spin-up VS endpoint
# MAGIC 2. Criar índice a partir da `pdf_text_chunks` tabela delta
...
# MAGIC %md
# MAGIC ### Conceda o acesso `SELECT` ao catálogo e ao índice criado aos usuários atuais &amp; `Usuários de conta`
# MAGIC Apenas para fins de demonstração
