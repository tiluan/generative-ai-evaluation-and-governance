...
# MAGIC %md
# MAGIC ## Tarefa 3: Implementar Guardrails com a Foundation Models API (FMAPI)
# MAGIC
...
response = w.serving_endpoints.<FILL_IN>
#
...
response = w.serving_endpoints.query(
    ...
    messages=messages,
    temperature: <FILL_IN>, # Defina o parâmetro de temperatura para controlar a aleatoriedade da resposta
    max_tokens=<FILL_IN>  # Defina o número máximo de tokens (palavras) na resposta
)
# Imprima o conteúdo da primeira mensagem na resposta
<FILL_IN>
